    ...
    def _load_icons(self):
        try:
            self.upload_icon = ImageTk.PhotoImage(
                Image.open("../byclass/assets/icons/upload.png").resize((20, 20), Image.Resampling.LANCZOS))
            self.rotate_left_icon = ImageTk.PhotoImage(
                Image.open("../byclass/assets/icons/rotate-left.png").resize((20, 20), Image.Resampling.LANCZOS))
            self.rotate_right_icon = ImageTk.PhotoImage(
                Image.open("../byclass/assets/icons/rotate-right.png").resize((20, 20), Image.Resampling.LANCZOS))
            self.help_icon = ImageTk.PhotoImage(
                Image.open("../byclass/assets/icons/help.png").resize((20, 20), Image.Resampling.LANCZOS))
            self.recognize_icon = ImageTk.PhotoImage(
                Image.open("../byclass/assets/icons/recognize.png").resize((20, 20), Image.Resampling.LANCZOS))
        except Exception as e:
